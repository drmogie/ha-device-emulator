...
async def async_setup_entry(
    ...
    """Set up the emulated light from a config entry."""
    if entry.data.get(CONF_DEVICE_TYPE) != DEVICE_TYPE_LIGHT:
        return
    async_add_entities([EmulatedLight(entry)])


class EmulatedLight(LightEntity):
    """A fake light with no real hardware behind it."""
